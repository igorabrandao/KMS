...
CREATE SCHEMA IF NOT EXISTS `u291948144_kms` DEFAULT CHARACTER SET utf8 COLLATE utf8_general_ci ;
USE `u291948144_kms` ;

-- -----------------------------------------------------
-- Table `u291948144_kms`.`tipoUsuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`tipoUsuario` (
...
-- -----------------------------------------------------
-- Table `u291948144_kms`.`faixa`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`faixa` (
...
-- -----------------------------------------------------
-- Table `u291948144_kms`.`endereco`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`endereco` (
...
-- -----------------------------------------------------
-- Table `u291948144_kms`.`usuario`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`usuario` (
  ...
  CONSTRAINT `TIPO_USUARIO_FK`
    ...
    REFERENCES `u291948144_kms`.`tipoUsuario` (`ID_TIPO_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `FAIXA_USUARIO_FK`
    FOREIGN KEY (`ID_FAIXA`)
    REFERENCES `u291948144_kms`.`faixa` (`ID_FAIXA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `ENDERECO_USUARIO_FK`
    FOREIGN KEY (`ID_ENDERECO`)
    REFERENCES `u291948144_kms`.`endereco` (`ID_ENDERECO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
...
-- -----------------------------------------------------
-- Table `u291948144_kms`.`associacao`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`associacao` (
...
-- -----------------------------------------------------
-- Table `u291948144_kms`.`evento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`evento` (
  ...
  CONSTRAINT `USUARIO_EVENTO_FK`
    ...
    REFERENCES `u291948144_kms`.`usuario` (`ID_USUARIO`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
...
-- -----------------------------------------------------
-- Table `u291948144_kms`.`pagamento`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`pagamento` (
...
-- -----------------------------------------------------
-- Table `u291948144_kms`.`aula`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`aula` (
...
-- -----------------------------------------------------
-- Table `u291948144_kms`.`frequencia`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `u291948144_kms`.`frequencia` (
  ...
  CONSTRAINT `id_aula_fk`
    FOREIGN KEY (`ID_AULA`)
    REFERENCES `u291948144_kms`.`aula` (`ID_AULA`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
;
