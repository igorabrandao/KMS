							...
							<div class="page-header">
								<h1 title="Cotação">Cotação <small>gestão </small></h1>
							</div>
							<!-- end: PAGE TITLE -->
						</div>
					</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-12 space20">
											<button class="btn btn-blue add-row" onClick="javascript:window.location.href='<?php echo HOME_URI;?>/modulo_solicitacao/cadastrar_cotacao';">
												Abrir nova cotação <i class="fa fa-plus"></i>
											</button>
