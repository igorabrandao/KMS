...
<script src="<?php echo HOME_URI;?>/assets/js/form_validation/form-validation-plataformaLD.js"></script>
...
<script>
	...
	//! Refresh the dynamic select after server request
	$('#ID_OPERADORA').on("change", function(e) {
		$("#ID_DEGRAU_LD").select2("val", "");
	})
	...
	jQuery(document).ready(function() {
		...
		/* Define field mask */
		$.mask.definitions['~'] = "[+-]";
			$("input[name=TARIFA_ESTADO]").maskMoney({allowZero:"true", symbol:"R$",decimal:",",thousands:"."})
	});
</script>