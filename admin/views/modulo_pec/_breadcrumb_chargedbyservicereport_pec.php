...
<ol class="breadcrumb">
	...
	<li>
		<?php
			if (isset($_GET['idPEC']) && $_GET['idPEC'] != '') {
		?>	
			<a href="<?php echo HOME_URI;?>/modulo_pec/chargedreport_pec?idPEC=<?php echo $_GET['idPEC']; ?>" title="O que está sendo cobrado">
				O que está sendo cobrado
			</a>
		<?php } else { ?>
			<a href="<?php echo HOME_URI;?>/modulo_pec/chargedreport_pec" title="O que está sendo cobrado">
				O que está sendo cobrado
			</a>
		<?php } ?>
	</li>
	<li class="active" title="Por serviço">
		Por serviço	
	</li>
</ol>
<!-- end: BREADCRUMB -->