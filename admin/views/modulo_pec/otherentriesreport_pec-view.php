							...
							<div class="page-header">
								<h1 title="Outros lançamentos">Outros lançamentos <small>relatório </small></h1>
							</div>
							<!-- end: PAGE TITLE -->
						</div>
					</div>
											...
											<tbody>
												<?php
													...
													foreach ( $data_value as $value )
													{
														...
														// Service description
														echo "<td><a href='" . encrypted_url($modelo->getIdPEC(), HOME_URI . "/modulo_pec/otherentriesreportbyregister_pec?idPEC=") . encrypted_url($value["ID_PEC_OUTRO_LANCAMENTO"], "&idLancamento=") . "' title='" . $value["DESCRICAO"] . "'>" . $value["DESCRICAO"] . "</a></td>";
