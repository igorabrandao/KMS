							...
							<div class="page-header">
								<h1 title="Detalhamento do que foi utilizado por linha">Detalhamento do que foi utilizado por linha <small>relatório </small></h1>
							</div>
							<!-- end: PAGE TITLE -->
						</div>
					</div>
											...
											<tbody>
												<?php
													...
													foreach ( $data_value as $value )
													{
														...
														// Service description
														echo "<td><a href='" . encrypted_url($modelo->getIdPEC(), HOME_URI . "/modulo_pec/relatoriolinhabyutilization_pec?idPEC=") . encrypted_url($value["ID_PEC_TIPO_UTILIZACAO"], "&idUtilizacao=") . "' title='" . $value["DESCRICAO"] . "'>" . $value["DESCRICAO"] . "</a></td>";
