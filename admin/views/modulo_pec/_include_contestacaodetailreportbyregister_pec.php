...
<script src="<?php echo HOME_URI;?>/assets/js/table_data_custom/table-data-contestacao-detail-register.js"></script>
...
<script>
	...
	*/
	...
	jQuery(document).ready(function() {
		...
		$("#VALOR_CALCULADO").maskMoney({allowZero:"true", allowNegative:"true", symbol:"R$",decimal:",",thousands:"."});
		$("#DIFF_VALUE").maskMoney({allowZero:"true", allowNegative:"true", symbol:"R$",decimal:",",thousands:"."});
