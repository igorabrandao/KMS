							...
							<div class="page-header">
								<h1 title="Contestação do detalhamento sobre a utilização">Contestação do detalhamento sobre a utilização <small>relatório </small></h1>
							</div>
							<!-- end: PAGE TITLE -->
						</div>
					</div>
								...
								<div class="panel-body">
									<div class="row">
										<div class="col-md-12 space20">
											<div class="btn-group pull-left">
												<h4 title="DETALHAMENTO POR UTILIZAÇÃO">DETALHAMENTO POR UTILIZAÇÃO</h4>
											</div>
									...
									<div class="table-responsive">
										<table class="table table-striped table-bordered table-hover" id="sample_1">
											<thead>
												<tr>
													<th style="white-space: nowrap; text-align: center;">UTILIZAÇÃO</th>
											...
											<tbody>
												<?php
													...
													$data_value = $modelo->utilizationreport_PEC($modelo->getIdPEC());
													...
													foreach ( $data_value as $value )
													{
														...
														// Service description
														echo "<td><a href='" . encrypted_url($modelo->getIdPEC(), HOME_URI . "/modulo_pec/contestacaodetailreportbyutilization_pec?idPEC=") . encrypted_url($value["ID_PEC_TIPO_UTILIZACAO"], "&idUtilizacao=") . "' title='" . $value["DESCRICAO"] . "'>" . $value["DESCRICAO"] . "</a></td>";

														// Total value
														$data_value = $modelo->get_detail_value_list($modelo->getIdPEC(), iif($value["ID_PEC_TIPO_UTILIZACAO"]), "", "");
