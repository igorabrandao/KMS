...
<ol class="breadcrumb">
	...
	<li>
		<?php
			if (isset($_GET['idPEC']) && $_GET['idPEC'] != '') {
		?>	
			<a href="<?php echo HOME_URI;?>/modulo_pec/contestacaootherentries_pec?idPEC=<?php echo $_GET['idPEC']; ?>" title="Contestação dos Outros Lançamentos">
				Contestação dos Outros Lançamentos
			</a>
		<?php } else { ?>
			<a href="<?php echo HOME_URI;?>/modulo_pec/contestacaootherentries_pec" title="Contestação dos Outros Lançamentos">
				Contestação dos Outros Lançamentos
			</a>
		<?php } ?>
	</li>
