							...
							<div class="page-header">
								<h1 title="Contestação do detalhamento por utilização">Contestação do detalhamento por utilização <small>relatório </small></h1>
							</div>
							<!-- end: PAGE TITLE -->
						</div>
					</div>
											...
											<tbody>
												<?php
													...
													foreach ( $data_value as $value )
													{
														...
														// Service description
														echo "<td><a href='" . encrypted_url($modelo->getIdPEC(), HOME_URI . "/modulo_pec/contestacaodetailreportbyregister_pec?idPEC=") . 
