...
<script src="<?php echo HOME_URI;?>/assets/js/table_data_custom/table-data-contestacaocontratado2.js"></script>
...
<script>
	...
	jQuery(document).ready(function() {
		...
		<?php if ( sizeof($pec_contestation_table) == 0 || ( isset($_GET["action"]) && $_GET["action"] == "edit" ) ) { ?>
			parseTableFields( "elem_ASSOC", "SERVICE_MODULE" );
		<?php } ?>
	});
