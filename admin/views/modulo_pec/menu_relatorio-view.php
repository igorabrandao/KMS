							...
							<div class="page-header">
								<h1 title="Visualização dos Relatórios">Visualização dos Relatórios <small>PEC </small></h1>
							</div>
							<!-- end: PAGE TITLE -->
						</div>
					</div>
					...
					<div class="row">
						<div class="col-sm-4">
							<div class="core-box">
								<div class="heading">
									<i class="clip-phone-2 circle-icon circle-color1"></i>
									<h2><a href="<?php echo encrypted_url($modelo->getIdPEC(), HOME_URI . "/modulo_pec/menu_relatoriolinha_pec?idPEC=");?>" title="Relatórios por linha">Relatórios por linha</a></h2>
								</div>
								<div class="content">
