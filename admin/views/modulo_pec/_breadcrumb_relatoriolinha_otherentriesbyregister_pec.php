...
<ol class="breadcrumb">
	...
	<li>
		<?php
			if (isset($_GET['idPEC']) && $_GET['idPEC'] != '') {
		?>
			<a href="<?php echo HOME_URI;?>/modulo_pec/menu_relatoriolinha_otherentries_pec?idPEC=<?php echo $_GET['idPEC']; ?>" title="Relatório de outros lançamentos">
				Relatório de outros lançamentos
			</a>
		<?php } else { ?>
			<a href="<?php echo HOME_URI;?>/modulo_pec/menu_relatoriolinha_otherentries_pec" title="Relatório de outros lançamentos">
				Relatório de outros lançamentos
			</a>
		<?php } ?>
	</li>
	<li class="active" title="Outros lançamentos por linha">
		Outros lançamentos por linha
	</li>
</ol>
<!-- end: BREADCRUMB -->