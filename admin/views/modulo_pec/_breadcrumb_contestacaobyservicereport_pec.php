...
<ol class="breadcrumb">
	...
	<li>
		<?php
			if (isset($_GET['idPEC']) && $_GET['idPEC'] != '') {
		?>	
			<a href="<?php echo HOME_URI;?>/modulo_pec/contestacaocontratado_pec?idPEC=<?php echo $_GET['idPEC']; ?>" title="Contestação dos Serviços Contratados">
				Contestação dos Serviços Contratados
			</a>
		<?php } else { ?>
			<a href="<?php echo HOME_URI;?>/modulo_pec/contestacaocontratado_pec" title="Contestação dos Serviços Contratados">
				Contestação dos Serviços Contratados
			</a>
		<?php } ?>
	</li>
	<li class="active" title="Avaliação dos itens contestados">
		Avaliação dos itens contestados
	</li>
</ol>
<!-- end: BREADCRUMB -->