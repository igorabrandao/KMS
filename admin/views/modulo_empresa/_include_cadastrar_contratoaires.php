...
<script src="<?php echo HOME_URI;?>/assets/js/form_validation/form-validation-contratoaires.js"></script>
...
<script>
	jQuery(document).ready(function() {
		...
		/* Define field mask */
		$.mask.definitions['~'] = "[+-]";
			$("#DATA_INICIO_CONTRATO").mask("99-99-9999");
			$("#GASTO_MENSAL_ESTIMADO").maskMoney({symbol:"R$",decimal:",",thousands:"."})
			$("#REDUCAO_MENSAL_ESTIMADA").maskMoney({symbol:"R$",decimal:",",thousands:"."})
			$("#REDUCAO_ANUAL_ESTIMADA").maskMoney({symbol:"R$",decimal:",",thousands:"."})
			$("#GASTO_MENSAL_FINAL").maskMoney({symbol:"R$",decimal:",",thousands:"."})
			$("#REDUCAO_MENSAL_FINAL").maskMoney({symbol:"R$",decimal:",",thousands:"."})
			$("#REDUCAO_ANUAL_FINAL").maskMoney({symbol:"R$",decimal:",",thousands:"."})
