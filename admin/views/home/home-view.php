...
<section id="content" class="container_12 clearfix" data-sort=true>
	...
	<div class="grid_12">
		<div class="box">
			...
			<div class="header">
				<h2><img class="icon" src="<?php echo HOME_URI;?>/assets/img/icons/packs/fugue/16x16/chart-up-color.png">Charts</h2>
	...
	<div class="grid_6">
		...
		<div class="box">
			...
			<div class="header">
				<h2><img class="icon" src="<?php echo HOME_URI;?>/assets/img/icons/packs/fugue/16x16/receipt-invoice.png">Invoices statistics</h2>
			</div>
		...
		<form class="box validate">
			...
			<div class="header">
				<h2><img class="icon" src="<?php echo HOME_URI;?>/assets/img/icons/packs/fugue/16x16/newspaper.png">Messages</h2>
			</div>
			...
			<div class="content">
				...
				<div class="messages full chat">
					...
					<div class="msg reply">
						<img src="<?php echo HOME_URI;?>/assets/img/icons/packs/iconsweets2/25x25/user-2.png"/>
						<div class="content">
	...
	<div class="grid_6">
		<div class="box">
			...
			<div class="header">
				<h2><img class="icon" src="<?php echo HOME_URI;?>/assets/img/icons/packs/fugue/16x16/calendar-select.png">Calendar</h2>
			</div>
	...
	<div class="grid_12">
		<div class="box">
			...
			<div class="header">
				<h2><img class="icon" src="<?php echo HOME_URI;?>/assets/img/icons/packs/fugue/16x16/table.png">Table</h2>
			</div>
