...
<section id="content" class="container_12 clearfix" data-sort=true>
	...
	<ul class="stats not-on-phone">
		...
		<li title="Última aula">
			<strong><?php echo $modelo->get_last_class(); ?></strong>
	...
	<div class="grid_12">
		<div class="box">
			...
			<div class="header">
				<h2><img class="icon" src="<?php echo HOME_URI;?>/assets/img/icons/packs/fugue/16x16/chart-up-color.png">Comparativo de registro de aluno nos últimos 3 anos (<?php echo date("Y") - 2; ?> - <?php echo date("Y"); ?>)</h2>
			</div>
