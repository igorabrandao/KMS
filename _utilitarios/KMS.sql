...
CREATE TABLE IF NOT EXISTS `KMS`.`aula` (
  ...
  `CONTEUDO_MINISTRADO` VARCHAR(5000) NULL,
...
CREATE TABLE IF NOT EXISTS `KMS`.`frequencia` (
  ...
  `DATA_FECHA` VARCHAR(20) NULL,
  PRIMARY KEY (`ID_FREQUENCIA`, `ID_ALUNO`, `ID_AULA`),
...
-- -----------------------------------------------------
-- Data for table `KMS`.`endereco`
-- -----------------------------------------------------
START TRANSACTION;
USE `KMS`;
INSERT INTO `KMS`.`endereco` (`ID_ENDERECO`, `CEP`, `LOGRADOURO`, `NUMERO`, `COMPLEMENTO`, `BAIRRO`, `CIDADE`, `ID_UF`, `DATA_FECHA`) VALUES (1, '59076-400', 'Av. Capitão Mor Gouveia', '', '', 'Lagoa Nova', 'Natal', 20, NULL);

COMMIT;


-- -----------------------------------------------------
-- Data for table `KMS`.`usuario`
-- -----------------------------------------------------
START TRANSACTION;
USE `KMS`;
INSERT INTO `KMS`.`usuario` (`ID_USUARIO`, `ID_TIPO_USUARIO`, `ID_FAIXA`, `PRIMEIRO_NOME`, `SOBRENOME`, `CPF`, `DATA_NASCIMENTO`, `SEXO`, `EMAIL`, `SENHA`, `TELEFONE`, `CELULAR`, `ID_ENDERECO`, `TIPO_SANGUINEO`, `FOTO`, `DATA_CADASTRO`, `SESSION_ID`, `DATA_FECHA`) VALUES (1, 1, 11, 'Admin', 'Legal', '123.456.789-11', '10/05/1985', 'M', 'admin@gmail.com', '$2a$08$y.96fFT2BPuEqazhm3962.rHfmbganzuJYG/L/8n6fCpwIAqbqjeS', NULL, NULL, 1, 'A+', NULL, '17-06-2016', NULL, NULL);
